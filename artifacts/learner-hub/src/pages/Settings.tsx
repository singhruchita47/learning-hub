  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-[1600px] mx-auto animate-in fade-in duration-500">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground mt-1">Configure your Learner Hub experience.</p>
      </div>
      <div className="rounded-2xl border border-border bg-white p-12 text-center shadow-sm">
        ...
        <p className="text-muted-foreground max-w-md mx-auto">Manage notifications, display themes, privacy settings, and connected accounts.</p>
      </div>
    </div>
  );
}
