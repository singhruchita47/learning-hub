...
export default function AdminFeedback() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-[1540px] mx-auto animate-in fade-in duration-500">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-slate-900">Campus Feedback Overview</h1>
        <p className="text-sm font-semibold text-slate-500 mt-1">Review student feedback across all courses and faculties.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3 mb-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-black text-slate-400 uppercase tracking-wider">Campus Avg Rating</p>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-black text-slate-400 uppercase tracking-wider">Health Status</p>
            <p className="text-2xl font-black text-emerald-600">Positive</p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        <div className="border-b border-slate-100 bg-slate-50 px-6 py-4">
          <h2 className="text-sm font-black text-slate-800">All Recent Feedback</h2>
        </div>
        <div className="divide-y divide-slate-100">
          {loading ? (
            <div className="p-8 text-center text-sm font-semibold text-slate-400">Loading feedback...</div>
          ) : feedbacks.length === 0 ? (
            <div className="p-8 text-center text-sm font-semibold text-slate-400">No feedback in the system yet.</div>
          ) : (
            feedbacks.map((item) => (
